...
int main( int argc, char** argv )
{
    ...
    for(int i=0; i < interval;i++){
		for(int j=0;j<width;j++){
			image2.at<Vec3b>(i,j)[0] = 255 - image.at<Vec3b>(start+i,j)[0];
			image2.at<Vec3b>(i,j)[1] = 255 - image.at<Vec3b>(start+i,j)[1];
			image2.at<Vec3b>(i,j)[2] = 255 - image.at<Vec3b>(start+i,j)[2];
		}
    }
	...
	if (rank == 0)
	{
		...
		imwrite("color_negative.jpg",image2);
